...
Use the release asset named like `sculpt_timelapse_capture-0.5.3.zip`. Do not use GitHub's green **Code > Download ZIP** button for installation; that downloads the source repository, not the packaged Blender extension.
...
Frames are captured from the active 3D View with Blender's OpenGL viewport render path.
