...
Use the release asset named like `sculpt_timelapse_capture-0.5.4.zip`. Do not use GitHub's green **Code > Download ZIP** button for installation; that downloads the source repository, not the packaged Blender extension.
